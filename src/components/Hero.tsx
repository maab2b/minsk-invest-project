...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-navy">
      ...
      {/* Content */}
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center pt-20 pb-12">
        <motion.div 
          ...
          className="max-w-3xl"
        >
          <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-sans font-extrabold tracking-tight leading-tight mb-4 text-white">
            Управление инвестициями в коммерческую недвижимость Беларуси
          </h1>
          
          <div className="h-1 w-24 bg-brand-gold mb-4"></div>
          ...
          <motion.button 
            ...
            className="group relative inline-flex items-center justify-center px-8 py-4 bg-brand-gold text-brand-navy font-semibold text-lg overflow-hidden transition-all hover:bg-brand-gold-light"
          >
